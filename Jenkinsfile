pipeline {
    ...
    environment {
        ...
        DOCKER_PWD = credentials('dockerhub_token')
    ...
    stages {
        ...
        stage('Docker Login') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'dockerhub_token', usernameVariable: 'DOCKER_USR', passwordVariable: 'DOCKER_PWD')]) {
